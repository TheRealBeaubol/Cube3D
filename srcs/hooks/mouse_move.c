...
int	is_hover(t_int_point point_1, t_int_point point_2, \
t_int_point mouse, int *sound)
{
...
1087, 509}, {1037, 530}, {1087, 578}, {1037, 599}, {1087, 647}, {\
840, 675}, {894, 723}};
	int					i;
	...
	while (i < 14)
	{
		if (is_hover(keybinds_pos[i], keybinds_pos[i + 1], \
pos, &cube->menu.sounds[i / 2]))
		{
